...
export default function LandingPage() {
  ...
  const features = [
    ...
    },
    {
      ...
      description: 'Send and receive money instantly to any PayWarden wallet.',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: 'Easy Deposits',
      description: 'Fund your wallet easily with cards, bank transfers, or USSD.',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'Developer-friendly APIs for seamless integration with your applications.',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  const steps = [
    ...
    },
    {
      number: '02',
      title: 'Fund Wallet',
      description: 'Add money to your wallet using Paystack',
    },
    {
      number: '03',
      title: 'Start Transacting',
      description: 'Send money, receive payments, and manage funds',
    },
  ];
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Send, receive, and manage your money with ease. Fast, secure, and built for the modern world.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button
                ...
                className="px-8 py-4 text-lg font-medium text-gray-700 hover:text-gray-900 transition-colors"
              >
                Learn More →
              </button>
            </div>
          ...
          <div className="mt-16 relative">
            <div className="bg-gradient-to-br from-primary-100 to-primary-200 rounded-2xl shadow-2xl overflow-hidden">
              <div className="aspect-[16/9] flex items-center justify-center">
                <div className="text-center p-12">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mb-2">Your Wallet Dashboard</h3>
                  <p className="text-gray-600">Manage all your transactions in one place</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-primary-600 to-primary-800">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-primary-100 mb-8">
            Join thousands of users managing their finances with PayWarden
          </p>
          <Button
      ...
      <footer className="bg-gray-900 text-gray-400 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div className="col-span-1 md:col-span-2">
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="text-xl font-bold text-white">PayWarden</span>
              </div>
              <p className="text-sm max-w-md">
                Your trusted digital wallet for fast, secure, and convenient money management.
              </p>
            </div>
          ...
          <div className="pt-8 border-t border-gray-800 text-sm text-center">
            <p>&copy; {new Date().getFullYear()} PayWarden. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
